...
class MovieServiceTest {
    ...
    private MovieService movieService = new MovieService(new ObjectsValidator<>());
    ...
    void createMovieTest() {
        ...
        // then
        assertTrue(movieService.movieDtoList.contains(createdMovie));
    }
    ...
    void deleteByIdTest() {
        ...
        // then
        assertAll(() -> {
            assertEquals(2, movieService.movieDtoList.size());
            assertFalse(movieService.movieDtoList.contains(defaultInMemory.get(0)));
        });
    }
    ...
    void updateByIdTest() {
        ...
        // then
        assertAll(() -> {
            assertEquals("Just movie", movieService.movieDtoList.get(0).getDescription());
            assertEquals(3, movieService.movieDtoList.get(1).getRate());
            assertEquals("Drama", movieService.movieDtoList.get(2).getGenre());
        });
    }
}