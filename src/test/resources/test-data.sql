INSERT INTO movie (title, description, produced_year, rate, director, main_actors, genre, created_date, last_modified_date)
VALUES
    ('Titanic', 'TEST A seventeen-year-old aristocrat falls in love with a kind but poor artist aboard the luxurious, ill-fated R.M.S. Titanic.',
